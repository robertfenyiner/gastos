...
if ! id -u robert >/dev/null 2>&1; then
    ...
    echo -e "Usuario 'robert' creado y con permisos sudo."
    echo -e "Copia este instalador a /home/robert y ejecútalo como usuario robert:"
    echo -e "sudo cp $0 /home/robert/${APP_NAME}-instalador.sh"
    echo -e "sudo chown robert:robert /home/robert/${APP_NAME}-instalador.sh"
    echo -e "sudo su - robert"
    echo -e "bash ${APP_NAME}-instalador.sh"
    exit 0
fi
